...
#   echo 'Enabling zsh-specific dependencies...'
    ...
    # Absolute filename of the user-specific zsh-specific "powerlevel10k"
    # configuration file, automatically generated by running this command:
    #     $ p10k configure
    local _POWERLEVEL10K_CONFIG_FILENAME="${HOME}/.config/zsh/.p10k.zsh"
